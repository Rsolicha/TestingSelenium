describe('Login', function() {
    ...
    it('P21 CrearBookingSinNombrePL0Cur1DT0BV1SS1Own1SC1PM3', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
        ...
        //Sale condition position 1
        element(by.xpath(`//*[@id="ui-select-choices-row-6-1"]`)).click().then(function() {
            browser.sleep(1000);
        });
        //Payment method select list
        element(by.xpath(`//*[@id="content"]/div/div[3]/div/div/div/div/ui-view/booking-detail-component/div/booking-detail/div[2]/div/div/form/div[1]/div[3]/div[5]/div/div/div[2]/div/div/a`)).click().then(function() {
    ...
    it('P22 CrearBookingConNombrePL0Cur0DT0BV0SS0Own0SC0PM0', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P23 CrearBookingConNombrePL0Cur0DT0BV0SS0Own0SC0PM1', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P24 CrearBookingConNombrePL0Cur0DT0BV0SS0Own0SC1PM1', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P25 CrearBookingConNombrePL0Cur0DT0BV0SS0Own1SC1PM1', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P26 CrearBookingConNombrePL0Cur0DT0BV0SS1Own1SC1PM1', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P28 CrearBookingConNombrePL0Cur1DT0BV1SS1Own1SC1PM1', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
        ...
        //Verify Button add booking is enable
        expect(element(by.xpath('//*[@id="content"]/div/div[3]/div/div/div/div/ui-view/booking-detail-component/div/booking-detail/div[2]/div/div/form/div[2]/button')).isEnabled()).toBe(true);
    });it('P27 CrearBookingConNombrePL0Cur0DT0BV1SS1Own1SC1PM1', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P29 CrearBookingConNombrePL1Cur1DT0BV1SS1Own1SC1PM1', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P30 CrearBookingConNombrePL1Cur1DT0BV1SS1Own1SC1PM2', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
    ...
    it('P31 CrearBookingConNombrePL0Cur1DT0BV1SS1Own1SC1PM2', async function() {
        browser.sleep(1000);
        //Button booking
        element(by.xpath(`//*[@id="nav"]/li[1]/span`)).click().then(function() {
            browser.sleep(1500);
